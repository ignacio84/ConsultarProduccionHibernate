...
public class XlsxImplPallets extends AbstractXlsx implements IXlsx<List<Pallet>, String> {
    ...
    private void renderContent() {
        ...
        for (Pallet pallet : listPallet) {
            ...
            this.addCell(column_++, pallet.getNumeroCajas(), this.cellStyleContent(null));
            this.addCell(column_++, Double.valueOf(pallet.getPeso()), this.cellStyleContent(STR_DECIMAL_FORMAT));
