...
public class PdfImplPallets extends AbstractPdf implements IPdf<List<Pallet>, String> {
    ...
    private void renderContent() {
        for (Pallet pallet : this.listPallets) {
            ...
            table.addCell(this.getCell(pallet.getNumeroCajas().toString(), BACKGROUND_COLOR_CONTENT, PdfPCell.ALIGN_CENTER, PdfPCell.ALIGN_MIDDLE, FNT_TABLE_CONTENT, 1, 1, 15));
